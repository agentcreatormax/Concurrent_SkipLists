(** Coarse grain implementation of hashtbl with similar interface as skiplist implementations for benchmarking *)

(** The type of a coarse-grain hashtbl. *)
type t

val create : int -> t
(** [create max_level] creates an empty coarse-grain hashtbl with initial hashtbl size as 2 ^ max_level
    [max_level].
